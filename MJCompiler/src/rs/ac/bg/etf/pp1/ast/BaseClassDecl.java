...
public class BaseClassDecl extends ClassDecl {

    private String className;
    private VarDeclList VarDeclList;
    private ClassMethods ClassMethods;

    public BaseClassDecl (String className, VarDeclList VarDeclList, ClassMethods ClassMethods) {
