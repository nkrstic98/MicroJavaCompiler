...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(LessEqOperator LessEqOperator) { visit(); }
    public void visit(LessOperator LessOperator) { visit(); }
    public void visit(GreaterEqOperator GreaterEqOperator) { visit(); }
    public void visit(GreaterOperator GreaterOperator) { visit(); }
    public void visit(NotEqualsOperator NotEqualsOperator) { visit(); }
    public void visit(EqualsOperator EqualsOperator) { visit(); }
    ...
    public void visit(BasicExpr BasicExpr) { visit(); }
    public void visit(TernarOperator TernarOperator) { visit(); }
    ...
    public void visit(DesFuncCallNoPars DesFuncCallNoPars) { visit(); }
    public void visit(DesFuncCall DesFuncCall) { visit(); }
    ...
    public void visit(NoRetVal NoRetVal) { visit(); }
    public void visit(RetVal RetVal) { visit(); }
    ...
    public void visit(OptFormParams OptFormParams) { visit(); }
    ...
    public void visit(BaseClassDecl BaseClassDecl) { visit(); }
    ...
    public void visit(NoConstDeclMore NoConstDeclMore) { visit(); }
    public void visit(ConstDeclMore ConstDeclMore) { visit(); }
    public void visit(ConstDecl ConstDecl) { visit(); }
    public void visit(ProgName ProgName) { visit(); }
    public void visit(ParamDeclDerived1 ParamDeclDerived1) { visit(); }
    public void visit(ClassParam ClassParam) { visit(); }
    public void visit(VarParam VarParam) { visit(); }
    public void visit(ConstParam ConstParam) { visit(); }
